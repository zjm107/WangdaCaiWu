...
namespace HyCommon
{
    public static class WebServiceConfig
    {
        ...
        public static string aConfigURL = "/BPO_FJSShiJianLiuZhuan.asmx";
        

        public static string aUserSerURL = "/BPO_RepuestApplicate_NoMatel.asmx";
        ...
        public static string ConfigURL = "/BPO_FJSShiJianLiuZhuan.asmx";
        

        public static string UserSerURL = "/BPO_RepuestApplicate_NoMatel.asmx";
