...
namespace WangDaDll
{
    public partial class FrmClientManagerSP : DevExpress.XtraEditors.XtraForm
    {
        public FrmClientManagerSP()
        {
            InitializeComponent();
        }
        ...
        private void FrmClientManager_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    layoutControl1.HideItem(流失审批Item);
                    cmb审批状态.Text = "待终审";
                }
                else if (Security.UserBusiness.Contains("注册主管"))
                {
                    layoutControl1.HideItem(流失终审Item);
                    cmb审批状态.Text = "待审批";
                }
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    csDataSet.GetClientInfoSP(客户名称TextEdit.Text, 公司类型ComboBoxEdit.Text
                    , 做账会计TextEdit.Text,cmb审批状态.Text);
                }
                else
                {
                    csDataSet.GetClientInfoSP(客户名称TextEdit.Text, 公司类型ComboBoxEdit.Text
                    , Security.UserName, cmb审批状态.Text);
                }
