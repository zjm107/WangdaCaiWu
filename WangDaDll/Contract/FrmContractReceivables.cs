...
namespace WangDaDll
{
    public partial class FrmContractReceivables : DevExpress.XtraEditors.XtraForm
    {
        public FrmContractReceivables()
        {
            InitializeComponent();
        }
        /// <summary>
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            //查询应收款
            contractDataSet.GetContractReceivables(signDate1, signDate2, clientName ); 
