...
namespace WangDaDll
{
    public partial class FrmContractReceivablesAccountant : DevExpress.XtraEditors.XtraForm
    {
        public FrmContractReceivablesAccountant()
        {
            InitializeComponent();
        }
        /// <summary>
        ...
        private void FrmContractReceivablesAccountant_Load(object sender, EventArgs e)
        {
