...
namespace WangDaDll
{
    public partial class FrmContractReceivablesPeriod : DevExpress.XtraEditors.XtraForm
    {
        public FrmContractReceivablesPeriod()
        {
            InitializeComponent();
        }
        /// <summary>
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            contractDataSet.GetReceivedPayment(clientName, signDate1, signDate2, receiptDate1, receiptDate2,""); 
        ...
        private void FrmContractReceivablesPeriod_Load(object sender, EventArgs e)
        {
