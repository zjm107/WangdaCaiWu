...
namespace WangDaDll
{
    public partial class FrmPaymentGeneralX : DevExpress.XtraEditors.XtraForm
    {
        public FrmPaymentGeneralX()
        {
            InitializeComponent();
        ...
        private void FrmPaymentGeneralX_Load(object sender, EventArgs e)
        {
            try {
                dstTCONF_WORD.FillDevComboBox("支付方式", 支付方式ComboBoxEdit);
                string newID = proceedsDataSet.NewPayment("无业绩收款");
