...
namespace WangDaDll
{
    public partial class FrmAccountantSalaryDetail : DevExpress.XtraEditors.XtraForm
    {
        public FrmAccountantSalaryDetail(int year,int month,string userID)
        {
            InitializeComponent();
            this.Year = year;
            this.Month = month;
        ...
        private void FrmAccountantSalaryDetail_Load(object sender, EventArgs e)
        {
            splash.ShowWaitForm();
