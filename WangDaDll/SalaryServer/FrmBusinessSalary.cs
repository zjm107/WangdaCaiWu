...
namespace WangDaDll
{
    public partial class FrmBusinessSalary : DevExpress.XtraEditors.XtraForm
    {
        public FrmBusinessSalary()
        {
            InitializeComponent();
        }
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (pageControl1.SelectedTabPageIndex == 0)
                {
                    ...
                    {
                        salaryDataSet.GetAllBusinessSum(year, month, UserID, "");
                    }
                    else
                    {
                        salaryDataSet.GetAllBusinessSum(year, month, UserID,Security.UserName);
                    }
                }
                else {
