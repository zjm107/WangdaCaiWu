...
namespace WangDaDll
{
    public partial class FrmBusinessSalaryDetail : DevExpress.XtraEditors.XtraForm
    {
        /// <summary>
        /// 
        /// </summary>
        /// <param name="salaryType">本年工资,上年工资</param>
        public FrmBusinessSalaryDetail(string salaryType, int year,int month,string userID)
        {
            InitializeComponent();
